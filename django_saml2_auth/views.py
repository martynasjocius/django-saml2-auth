...
def welcome(r):
    try:
        ...
        return HttpResponseRedirect(settings.SAML2_AUTH.get('LOGIN_REDIRECT_URL', get_reverse('admin:index')))
...
def acs(r):
    ...
    next_url = r.session.get('login_next_url', settings.SAML2_AUTH.get('LOGIN_REDIRECT_URL', get_reverse('admin:index')))
...
def signin(r):
    ...
    next_url = r.GET.get('next', settings.SAML2_AUTH.get('LOGIN_REDIRECT_URL', get_reverse('admin:index')))
